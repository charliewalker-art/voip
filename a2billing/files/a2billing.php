...
// PATCH : FSROOT n'est jamais défini dans le chemin d'exécution AGI pur
// (uniquement par les interfaces web admin/agent/customer, non déployées ici)
...
$result = $A2B->instance_table->SQLExec($A2B->DBHandle, $QUERY, 1, 0);
